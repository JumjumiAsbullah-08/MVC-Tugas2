    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="member" class="navbar-brand mx-4 mb-3">
                ...
                <div class="navbar-nav w-100">
                    <a href="member" class="nav-item nav-link" ><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="laporan_member" class="nav-item nav-link active"><i class="fa fa-newspaper me-2"></i>Laporan</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <button class="btn btn-warning mb-4" style="margin-left:1140px !important;"> <a href="cetak" target="_blank" style="color:black !important;"><i class="fa fa-print"></i> Cetak</a> </button>

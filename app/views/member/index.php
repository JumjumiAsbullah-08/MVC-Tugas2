        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"> <?php echo $_SESSION['user_nama']; ?></h6>
                        <span>Member</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    <a href="admin" class="nav-item nav-link active" ><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="laporan_member" class="nav-item nav-link"><i class="fa fa-newspaper me-2"></i>Laporan</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
